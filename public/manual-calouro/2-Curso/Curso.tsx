...
const semestres: Semestre[] = [
  {
    ...
    disciplinas: [
      {
        codigo: 'ARQ011',
        nome: 'DESENHO TÉCNICO I',
        cargaHoraria: 60,
        ementa:
          'Introdução ao Desenho técnico, Sistemas de Representação, Desenho Arquitetônico e Desenhos Especializados.',
      },
      {
        codigo: 'ENG439',
      ...
      },
      {
        ...
        cargaHoraria: 60,
        ementa:
          'Conceitos básicos relativos ao estudo do movimento. Cinemática das partículas. Leis de Newton. Trabalho e energia. Conservação da energia e do movimento linear. Impulson e Colisões. Rotação dos Corpos rígidos. Conservação do movimento angular.',
      },
      {
        codigo: 'FISD42',
        ...
        cargaHoraria: 30,
        ementa:
          'Neste curso será feita uma breve apresentação da teoria das medidas físicas, da teoria de erros e da análise gráfica para os trabalhos de laboratório. As apostilas Teoria de Erros e Roteiros de Laboratório – Mecânica, que serão utilizadas no curso, podem ser obtidas no site do Instituto de Física.',
      },
      {
        codigo: 'MATA01',
        ...
        cargaHoraria: 60,
        ementa:
          'Álgebra vetorial. A translação e a rotação de eixos. A reta e o plano no espaço R3. As cônicas. As superfícies de revolução.',
      },
      {
        codigo: 'MATA02',
        nome: 'CÁLCULO A',
      ...
      },
      {
        ...
        cargaHoraria: 60,
        ementa:
          'Estrutura e propriedades periódicas dos elementos e compostos químicos. Tópicos básicos da físico-química.',
      },
    ],
  },

  {
    ...
    disciplinas: [
      ...
      },
      {
        ...
        cargaHoraria: 30,
        ementa:
          'Introdução à instrumentação eletrônica e medições; utilização de multímetros, osciloscópios e geradores de sinais; montagem e análise experimental de circuitos resistivos e com componentes básicos.',
      },
      {
        codigo: 'ENGC29',
        ...
        cargaHoraria: 60,
        ementa:
          'Conceito de ciência. Classificação e divisão da ciência. Métodos científicos: indutivo, dedutivo, hipotético-dedutivo e dialético. Teorias, leis e fatos. Hipóteses e variáveis. Comunicação do conhecimento científico. Elaboração de trabalhos científicos: estrutura do texto científico e a numeração progressiva, apresentação de citações, uso de tabelas, quadros e figuras, redação de textos - estilo e linguagem. Apresentação de trabalho científico normalizado: apresentação do trabalho acadêmico, elementos pre-textuais e pós textuais, disposição gráfica e formato, apresentação de artigo em publicação periódica científica impressa.',
      },
      {
        codigo: 'FISD34',
        ...
        cargaHoraria: 60,
        ementa:
          'Abordagem teórica dos seguintes temas: oscilacões mecânicas, ondas mecânicas em uma dimensão, ondas sonoras, mecânica dos fluídos, teoria cinética dos gases, temperatura e calor, e leis da termodinâmica.',
      },
      {
        codigo: 'FISD41',
        ...
        cargaHoraria: 30,
        ementa:
          'Atividades experimentais na modalidade presencial, com possibilidade de realização de experimentos virtuais, sobre os assuntos: teoria de erros, oscilações mecânicas, ondas mecânicas, mecânica dos fluidos e termodinâmica.',
      },
      {
        codigo: 'MAT045',
      ...
      },
      {
        ...
        cargaHoraria: 60,
        ementa:
          'Matrizes e sistemas lineares. Espaços vetoriais. Produto interno. Transformações lineares. Diagonalização de operadores.',
      },
    ],
  },

  {
    ...
    disciplinas: [
      ...
      },
      {
        ...
        cargaHoraria: 60,
        ementa:
          'Estudo teórico da teoria da eletricidade e do magnetismo clássicos, visando proporcionar ao estudante um conhecimento geral das leis e fenômenos do Eletromagnetismo necessários ao ciclo profissional.',
      },
      {
        codigo: 'FISD40',
        ...
        cargaHoraria: 30,
        ementa:
          'Estudo experimental do eletromagnetismo clássico, objetivando aprendizagem de conceitos fundamentais da eletrodinâmica, suas aplicações em casos práticos na física e na engenharia, bem como o desenvolvimento de habilidades de laboratório e de prática científica.',
      },
      {
        codigo: 'MATA04',
        nome: 'CÁLCULO C',
    ...
    disciplinas: [
      {
        ...
        cargaHoraria: 60,
        ementa:
          'Propriedades dos fluídos. Hidrostática. Cinemática e Dinâmica dos Fluídos, transferência de Calor e de Massa.',
      },
      {
        codigo: 'ENGC24',
      ...
      },
      {
        ...
        cargaHoraria: 60,
        ementa:
          'Atividades experimentais associadas às disciplinas Dispositivos Eletrônicos, Análise de Circuitos II, Sinais e Sistemas I, Eletrônica Digital.',
      },
      {
        codigo: 'ENGC40',
        ...
        cargaHoraria: 30,
        ementa:
          'Técnicas de implementação de circuitos digitais. Memórias. Multiplexadores. FPGAs. Registradores de deslocamento. Circuitos aritméticos: somadores e multiplicadores paralelo e seqüencial. Linguagem de descrição de Hardware (VHDL). Projeto de sistemas digitais. Famílias lógicas: propriedades e construção de portas lógicas.',
      },
      {
        codigo: 'ENGC41',
      ...
      },
      {
        ...
        cargaHoraria: 60,
        ementa:
          'Estudo das ondas eletromagnéticas em nível básico, e suas implicações nos fenômenos ópticos. Introdução à Teoria da Relatividade Restrita e à Teoria Quântica.',
      },
      {
        codigo: 'FISD39',
        ...
        cargaHoraria: 30,
        ementa:
          'Estudo experimental das ondas eletromagnéticas e fenômenos ópticos, aprendizagem de conceitos fundamentais relacionados, suas aplicações em casos práticos na física e na engenharia, bem como o desenvolvimento de habilidades de laboratório e de prática científica.',
      },
    ],
  },

  {
    ...
    disciplinas: [
      ...
      },
      {
        ...
        cargaHoraria: 60,
        ementa:
          'Atividades experimentais associadas às disciplinas Eletromagnetismo, Eletrônica Analógica, Sinais e Sistemas II e Sistemas Microprocessados',
      },
      {
        codigo: 'ENGC50',
        ...
        cargaHoraria: 60,
        ementa:
          'Arquitetura de CPU: registradores, barramentos, pipelines, caches. Arquitetura de memórias. Dispositivos de entrada/saída, dispositivos periférico, barramentos padrões. Interrupção. Acesso direto a memória. Redes de microprocessadores. Programação de microprocessadores: tipo e formatos de instruções, modos de endereçamento, linguagens de máquina e Assembly. Microcontroladores. Análise e projeto de "hardware". Aplicações.',
      },
      {
        codigo: 'ENGC51',
      ...
      },
      {
        ...
        cargaHoraria: 60,
        ementa:
          'Erros nas aproximações numéricas. Série de Taylor. Resolução numérica de sistemas de equações lineares. Resolução de equações algébricas e trascendentes. Interpolação e diferenças finitas. Diferenciação e integração numérica. Resolução numérica de equações diferenciais',
      },
      {
        codigo: 'MAT236',
        ...
        cargaHoraria: 60,
        ementa:
          'Aspectos preliminares do trabalho estatístico. Séries estatísticas e representação gráfica. Médias. Separatrizes. Principais medidas de dispersão. Conceito, teoremas e leis de probabilidade. Distribuições de probabilidades. Distribuições amostrais. Intervalos de confiança. Teste de hipótese. Correlação e regressão linear simples. Ajustamento de funções matemáticas pelo método dos mínimos quadrados.',
      },
    ],
  },

  {
    ...
    disciplinas: [
      ...
      },
      {
        ...
        cargaHoraria: 60,
        ementa:
          'Modelos e impedâncias de equipamentos, em regimes permanente e transitório. Valores em por unidade. Circuitos elétricos desequilibrados. Componentes simétricos. Diagramas de seqüência. Faltas simétricas e assimétricas.',
      },
      {
        codigo: 'ENGC46',
...

  {
    ...
    disciplinas: [
      ...
      },
      {
        ...
        cargaHoraria: 60,
        ementa:
          'Características básicas dos sistemas de controle, realimentação, análise pelo Lugar das Raízes, análise da resposta em freqüência, critério de estabilidade de Nyquist, especificações de desempenho no domínio da freqüência, técnicas de compensação, controladores P, PI, PID, redes em avanço-atraso, projeto via Lugar das Raízes, projeto via resposta em freqüência.',
      },
      {
        codigo: 'ENGC43',
      ...
      },
      {
        ...
        cargaHoraria: 60,
        ementa:
          'A problemática ambiental. Biodiversidade. Impactos negativos no ambiente resultante do desenvolvimento dos processos produtivos e pelo consumo. Os diversos tipos de poluição. Prevenção da Poluição e Tecnologias Limpas. Legislação Ambiental aplicada. Avaliação de Impactos. Gestão Ambiental.',
      },
    ],
  },
    ...
    disciplinas: [
      {
        ...
        cargaHoraria: 60,
        ementa:
          'Funções e princípios da administração e organização de empresas. Planejamento e controle administrativo. Administração geral e específica. Administração de pessoal. Administração financeira. Administração de suprimentos. Administração contábil.',
      },
      {
        codigo: 'ENGC45',
        nome: 'INSTALAÇÕES E EQUIPAMENTOS ELÉTRICOS I',
        cargaHoraria: 60,
        ementa:
          'Padrões e normas técnicas pertinentes. Luminotécnica. Instalações prediais, especiais e comerciais em baixa tensão. Instalações telefônicas. Aterramento. Tecnologia e especificação de equipamentos para baixa tensão: disjuntores, chaves, reatores, pára-raios, capacitores, TC e TP. Normas e ensaios.',
      },
      {
        codigo: 'ENGC48',
        ...
        cargaHoraria: 60,
        ementa:
          'Dispositivos de potência: TBJ, MOSFET, IGBT, GTO, tiristores. Comutação. Retificadores a tiristor. Circuitos básicos para controle de fase. Técnicas de modulação. Conversores CC-CC. Conversores CC-CA. Dissipação térmica. Aplicações.',
      },
      {
        codigo: 'ENGC52',
        ...
        cargaHoraria: 60,
        ementa:
          'A questão energética. O Balanço energético. Recursos e fontes energéticas. Centrais hidrelétricas e nucleares. Centrais termelétricas: ciclos termodinâmicos, combustíveis, estudos, equipamentos e especificidades. Geração distribuída. Fontes alternativas: solar, eólica, biomassa e células de combustível.',
      },
      {
        codigo: 'ENGC55',
        nome: 'LABORATÓRIO INTEGRADO VII',
        cargaHoraria: 30,
        ementa:
          'Atividades experimentais associadas às disciplinas Geração de Energia Elétrica, Instalações e Equipamentos Elétricos e Eletrônica de Potência.',
      },
    ],
  },
    ...
    disciplinas: [
      {
        ...
        cargaHoraria: 60,
        ementa:
          'Previdência Social. Assistência Social. Legislação Trabalhista. Código Civil. Segurança Social.',
      },
      {
        codigo: 'ECOB40',
        ...
        cargaHoraria: 60,
        ementa:
          'Principais escolas do pensamento econômico. Conceitos econômicos básicos. Oferta, demanda, elasticidades, excedente do produtor e do consumidor. Custos de produção. Estruturas de mercado: concorrência perfeita, monopólio, oligopólio e concorrência monopolística. A renda nacional e outros agregados. O fluxo circular da renda. Emprego e distribuição de renda. Moeda e inflação. Crescimento econômico',
      },
      {
        codigo: 'GENG0035',
        nome: 'ESTÁGIO CURRICULAR EM ENGENHARIA ELÉTRICA',
        cargaHoraria: 180,
        ementa:
          'Atividade compatível com a profissão, realizada em Empresa ou Instituição, supervisionada obrigatoriamente por um engenheiro eletricista e por um professor do Departamento de Engenharia Elétrica.',
      },
      {
        codigo: 'GENG0036',
    ...
    disciplinas: [
      {
        ...
        cargaHoraria: 60,
        ementa:
          'Execução do projeto de conclusão de curso aprovado. Elaboração de monografia ou artigo científico, sob supervisão de um(a) professor(a) orientador(a). Defesa do trabalho perante banca examinadora.',
      },
    ],
  },
];

const AbasCurso: React.FC = () => {
  const [activeIndex, setActiveIndex] = useState<number>(0);
  const [openEmenta, setOpenEmenta] = useState<string | null>(null);

  const activeSemestre = semestres[activeIndex];

  const darkPrimary = '#0056b3';
  const lightGray = '#f8f9fa';
  const ementaBg = '#e9ecef';
  ...
  const getPdfDownloadLink = (
    ...
    const linkMap: { [key: string]: string } = {
      ADM012:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/adm012_-_administracao_10-06-2008.pdf',
      ARQ011:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/arq011_-_desenho_tecnico_i_1996.pdf',
      DIR175:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/dir175_-_legislacao_social_2007.pdf',
      ECO151:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/eco151_-_economia_e_financas_2008.pdf',
      ENG269:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/eng269_-_ciencias_do_ambiente_nao_identificado.pdf',
      ENG295:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/eng295_-_higiene_e_seguranca_do_trabaho_2008.pdf',
      ENG370:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/eng370_-_fenomenos_de_transportes_i_2008.pdf',
      ENG439:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/eng439_-_introducao_a_engenharia_eletrica_ap_27-03-2014.pdf',
      ENGA47:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/enga47_-_tecnologia_dos_materiais_para_eng._eletrica_ap_31-10-2016.pdf',
      ENGC24:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc24_-_sinais_e_sistemas_i_ap_31-10-2016.pdf',
      ENGC25:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc25_-_analise_de_circuitos_ii_ap_31-10-2016.pdf',
      ENGC26:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc26_-_sistemas_logicos_ap_31-10-2016.pdf',
      ENGC27:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc27_-_sistemas_de_comunicacoes_i_ap_31-10-2016.pdf',
      ENGC28:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc28_-_laboratorio_integrado_i_ap_27-03-2014.pdf',
      ENGC29:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc29_-_metodologia_e_expressao_do_conhecimento_cientifico_ap_27-03-2014.pdf',
      ENGC32:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc32_-_analise_de_circuitos_i_ap_31-10-2016.pdf',
      ENGC33:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc33_-_sinais_e_sistemas_ii_ap_31-10-2016.pdf',
      ENGC34:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc34_-_eletromagnetismo_aplicado_ap_31-10-2016.pdf',
      ENGC35:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc35_-_modelagem_e_analise_de_sistemas_dinamicos_ap_31-10-2016.pdf',
      ENGC36:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc36_-_dispositivos_de_conversao_eletromecanica_i_ap_19-12-2008.pdf',
      ENGC37:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc37_-_laboratorio_integrado_ii_ap_27-03-2014.pdf',
      ENGC38:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc38_-_laboratorio_integrado_iii_ap_27-03-2014.pdf',
      ENGC39:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc39_-_laboratorio_integrado_iv_ap_27-03-2014.pdf',
      ENGC40:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc40_-_eletronica_digital_ap_31-10-2016.pdf',
      ENGC41:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc41_-_dispositivos_eletronicos_ap_31-10-2016.pdf',
      ENGC42:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc42_-_sistemas_de_controle_i_ap_31-10-2016.pdf',
      ENGC43:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc43_-_dispositivos_de_conversao_eletromecanica_ii_ap_27-03-2014.pdf',
      ENGC44:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc44_-_sistemas_de_potencia_i_ap_27-03-2014.pdf',
      ENGC45:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc45_-_instalacoes_e_equipamentos_eletricos_iap_27-03-2014.pdf',
      ENGC46:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc46_-_sintese_de_circuitos_ap_31-10-2016.pdf',
      ENGC47:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc47_-_transmissao_e_distribuicao_de_energia_eletrica_ap_27-03-2014.pdf',
      ENGC48:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc48_-_eletronica_de_potencia_ap_27-03-2014.pdf',
      ENGC49:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc49_-_medicao_de_grandezas_fisicas_ap_27-03-2014.pdf',
      ENGC50:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc50_-_sistemas_microprocessados_ap_31-10-2016.pdf',
      ENGC51:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc51_-_eletronica_analogica_ap_27-03-2014.pdf',
      ENGC52:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc52_-_geracao_de_energia_eletrica_ap_27-03-2014.pdf',
      ENGC53:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc53_-_laboratorio_integrado_v_ap_27-03-2014.pdf',
      ENGC54:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc54_-_laboratorio_integrado_vi_ap_27-03-2014.pdf',
      ENGC55:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc55_-_-_laboratorio_integrado_vii_ap_27-03-2014.pdf',
      ENGC56:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc56_-_trabalho_final_de_graduacao_ap_29-06-2017.pdf',
      ENGC57:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/engc57_-_estagio_curricular_em_engenharia_eletrica_ap_29-06-2017.pdf',
      FIS121:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/fis121_-_fisica_geral_e_experimental_i_-_e_22-04-2004.pdf',
      FIS122:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/fis122_-_fisica_geral_e_experimental_ii_-_e_22-04-2004.pdf',
      FIS123:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/fis123_-_fisica_geral_e_experimental_iii_-_e_sem_data.pdf',
      FIS124:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/fis124_-_fisica_geral_e_experimental_iv_-_e_sem_data.pdf',
      MAT045:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/mat045_-_processamento_de_dados_1998.pdf',
      MAT174:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/mat174_-_calculo_numerico_i_sem_data.pdf',
      MAT236:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/mat236_-_metodos_estatisticos_06-01-2005.pdf',
      MATA01:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/mata01_-_geometria_analitica_28-08-2006.pdf',
      MATA02:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/mata02_-_calculo_a_11-05-2005.pdf',
      MATA03:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/mata03_-_calculo_b_11-05-2005.pdf',
      MATA04:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/mata04_-_calculo_c_11-05-2005.pdf',
      MATA06:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/mata06_-_calculo_e_11-05-2005.pdf',
      MATA07:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/mata07_-_algebra_linear_a_28-08-2006_0.pdf',
      QUI029:
        'https://www.eng.ufba.br/sites/eng.ufba.br/files/qui029_-_quimica_geral_19-11-2007.pdf',
    };

    return (
      linkMap[codigo] ||
      `##LINK-PARA-${codigo}-NAO-ENCONTRADO##`
    );
  };
  ...
  return (
    <>
      ...
      >
        ...
        >
          <p>
            O curso de Engenharia Elétrica da UFBA, sediado na Escola
            Politécnica, é um bacharelado diurno com duração de cinco anos,
            destinado à formação de profissionais capacitados para projetar,
            implementar e gerenciar sistemas relacionados às áreas de energia,
            telecomunicações, eletrônica e automação. O curso possui ênfase em
            sistemas elétricos de potência, eletrônica, sistemas de
            telecomunicações e controle e automação. Em 2023, o curso alcançou
            a sexta colocação nacional no Exame Nacional de Desempenho dos
            Estudantes (Enade), destacando-se entre os cursos de Engenharia
            Elétrica avaliados no país.
          </p>
          ...
          <p>
            <a
              href="https://eng.ufba.br/curso-graduacao/engenharia-eletrica"
              target="_blank"
            ...
            >
              Site da Escola Politécnica – Engenharia Elétrica
            </a>
          </p>

          <p>
            <a
              href="https://alunoweb.ufba.br/SiacWWW/ListaDisciplinasEmentaPublico.do?cdCurso=104140&nuPerCursoInicial=20231"
              target="_blank"
              rel="noopener noreferrer"
              style={{
                color: darkPrimary,
            ...
            >
              Lista de disciplinas e ementas – SIAC/UFBA
            </a>
          </p>
        </div>
        ...
        >
          ...
          <p>
            Selecione o semestre para visualizar as disciplinas.
          </p>
        </div>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  transition: 'all 0.2s',
                  transform: isActive
                    ? 'translateY(-2px) perspective(1px) skewX(-10deg)'
                    : 'perspective(1px) skewX(-10deg)',
                  marginRight: '0px',
                  flexShrink: 0,
                }}
              >
        ...
        >
          ...
          <ul className="list-group">
            {activeSemestre.disciplinas.map((disc) => (
